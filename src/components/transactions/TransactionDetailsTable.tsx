        ...
        <div className="bg-white border border-[#e7e8ea] border-solid grow relative rounded shrink-0 w-full">
          <div className="flex flex-col items-start overflow-hidden relative rounded-[inherit] size-full">
            ...
            <div className="bg-white flex items-start relative shrink-0 w-full">
              <div className="border-r border-[#e7e8ea] border-solid h-10 relative shrink-0 w-[120px] sm:w-[205px]">
                <div className="h-10 overflow-hidden relative rounded-[inherit] w-[120px] sm:w-[205px]">
                  <p className="absolute bottom-8 font-normal leading-6 left-2 sm:left-4 not-italic right-2 sm:right-4 text-[12px] sm:text-[14px] text-[#131b31] tracking-[-0.084px] translate-y-[100%]">
                    Field
                  </p>
            ...
            {details.map((detail, index) => (
              <div key={index} className="bg-[#f7f7f8] flex items-start relative shrink-0 w-full">
                <div className="border-r border-[#e7e8ea] border-solid h-10 relative shrink-0 w-[120px] sm:w-[205px]">
                  <div className="h-10 overflow-hidden relative rounded-[inherit] w-[120px] sm:w-[205px]">
                    <p className="absolute font-normal leading-6 left-2 sm:left-4 not-italic right-2 sm:right-4 text-[12px] sm:text-[14px] text-[#9296a0] top-2 tracking-[-0.084px]">
                      {detail.field}
                    </p>
                    <div className="absolute bg-[#e7e8ea] bottom-0 h-px left-0 right-0" />
                  </div>

...
const JsonPreview = ({ jsonData, onCopy }: JsonPreviewProps) => {
  return (
    <div className="bg-white border border-[#e7e8ea] border-solid flex-1 h-full relative rounded-2xl w-full lg:w-auto">
      <div className="flex flex-col gap-4 items-start overflow-hidden p-4 sm:p-6 relative rounded-[inherit] size-full">
        ...
        <div className="bg-[#f7f7f8] border border-[#e7e8ea] border-solid flex-1 relative rounded w-full overflow-hidden">
          <div className="flex flex-col flex-1 items-start relative rounded w-full h-full overflow-auto">
            <div className="flex flex-col gap-2 flex-1 items-start overflow-auto px-2 py-3.5 relative rounded-lg w-full">

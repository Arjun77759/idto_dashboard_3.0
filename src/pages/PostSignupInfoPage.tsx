...
const PostSignupInfoPage = () => {
  ...
  // Don't render if not mobile or in production (will redirect)
    ...
    <div className="min-h-screen w-full bg-white flex flex-col gap-8 p-5">
      ...
      <div className="flex flex-col gap-8 items-center text-center w-full">
        ...
        <div className="flex flex-col gap-2 items-center">
          ...
          <p className="text-[14px] font-medium leading-[20px] text-[#616675] tracking-[-0.14px] max-w-[283px]">
            Switch to your desktop for full access, or continue verification here.
          </p>
        </div>

        {/* Laptop Icon */}
        <div className="size-[58px] flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="58" height="58" viewBox="0 0 58 58" fill="none">
            <g clip-path="url(#clip0_645_5196)">
              <path d="M48.3333 44.7082C50.9917 44.7082 53.1425 42.5332 53.1425 39.8749L53.1667 13.2916C53.1667 10.6333 50.9917 8.45825 48.3333 8.45825H9.66667C7.00833 8.45825 4.83333 10.6333 4.83333 13.2916V39.8749C4.83333 42.5332 7.00833 44.7082 9.66667 44.7082H0C0 47.3666 2.175 49.5416 4.83333 49.5416H53.1667C55.825 49.5416 58 47.3666 58 44.7082H48.3333ZM9.66667 13.2916H48.3333V39.8749H9.66667V13.2916ZM29 47.1249C27.6708 47.1249 26.5833 46.0374 26.5833 44.7082C26.5833 43.3791 27.6708 42.2916 29 42.2916C30.3292 42.2916 31.4167 43.3791 31.4167 44.7082C31.4167 46.0374 30.3292 47.1249 29 47.1249Z" fill="#131B31" />
            </g>
            <defs>
              <clipPath id="clip0_645_5196">
        ...
        {/* Divider and Mode Transition */}
        <div className="flex flex-col gap-6 items-start w-full">
          {/* Divider */}
          <div className="h-px w-full bg-[#9296a0]" />

          {/* Mode Transition Visual */}
          <div className="bg-[#f7f7f8] h-[210px] overflow-hidden relative rounded-[8px] w-full flex items-center justify-center">
            <img src='/postsignup.png' className='w-full h-auto' />
          </div>

          {/* Secondary Message */}
          <p className="text-[14px] font-medium leading-[20px] text-[#616675] text-center tracking-[-0.14px] w-full">
            <span>You can still complete your verification right here to get ready for </span>
            <span className="text-[#006042]">Live Mode</span>
          </p>

          {/* Continue Button */}
          <button
            onClick={handleContinue}
            className="flex h-12 w-full items-center justify-center gap-2 rounded-[8px] border border-[#e7e8ea] bg-[#E6E8FF] text-[12px] font-bold leading-[16px] text-[#0019FF] transition hover:opacity-90 tracking-[-0.12px]"
          >
...
export default PostSignupInfoPage

        ...
        <div className="flex-1 flex justify-center px-4 pb-8">
          <div className="w-full max-w-full flex flex-col gap-6">
            ...
            <div className="text-center flex flex-col gap-2">
              <h1 className="text-[24px] font-[500] leading-[1.25] text-[#131b31]">Start your journey with idto</h1>
              <p className="text-[14px] font-medium leading-[20px] text-[#616675]">Create your secure, verified workspace.</p>
            </div>
            ...
            <form className="flex flex-col gap-6" onSubmit={handleSubmit} noValidate>
              ...
              >
                {submitting ? 'Submitting...' : 'Get started securely'}
                <MoveRight className="size-4" strokeWidth={2} />
              </button>

              {/* Secure link info */}
              <p className="text-[12px] font-normal leading-[16.8px] text-center text-[#616675]">You'll receive a secure one-click sign-in link.</p>
            </form>

...
const MobileProductionRedirectPage = () => {
    ...
    // Don't render if not mobile or not in production (will redirect)
    ...
    return (
        <div className="min-h-screen w-full bg-white flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center pb-8">
                <div className="flex flex-col items-center justify-center p-8 text-center w-full max-w-sm">
                    {/* Icons */}
                    ...
                    <div className="space-y-2 mb-6">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            The dashboard is only available on desktop devices for production accounts. Please switch to a desktop device to access your account.
                        </p>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-sm text-blue-700">
                                    Production accounts require advanced features and secure access that work best on larger screens with full keyboard and mouse support.
                                </p>
                            </div>
                        </div>
                    </div>
...
export default MobileProductionRedirectPage
